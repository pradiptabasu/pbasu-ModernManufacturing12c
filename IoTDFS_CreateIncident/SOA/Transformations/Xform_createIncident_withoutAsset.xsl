...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns1="http://xmlns.oracle.com/pcbpel/adapter/db/top/getContactDetails"
                ...
                xmlns:ns3="http://xmlns.oracle.com/pcbpel/adapter/db/SOACS/IoTDFS_CreateIncident/getContactDetails"
    ...
    <tns:Create>
      <tns:RNObjects xsi:type="ns9:Incident">
        <xsl:variable name="query2"
                      select="concat (&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;, &quot;'&quot;, /ns0:CustomerIncidentReq/ns0:Category, &quot;'&quot;, &quot; and isa='&quot;, $Invoke_getContactDetailsSelect_OutputVariable.DfsContactDetailsViewCollection/ns1:DfsContactDetailsViewCollection/ns1:DfsContactDetailsView/ns1:isa, &quot;'&quot; )"/>
        <ns9:Category>
        ...
        <xsl:variable name="query1"
                      select="concat (&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;, &quot;'&quot;, /ns0:CustomerIncidentReq/ns0:Severity, &quot;'&quot;, &quot; and isa='&quot;, $Invoke_getContactDetailsSelect_OutputVariable.DfsContactDetailsViewCollection/ns1:DfsContactDetailsViewCollection/ns1:DfsContactDetailsView/ns1:isa, &quot;'&quot; )"/>
        <ns9:Severity>
          <ns7:ID id='{oraext:query-database($query1,false(),false(),"jdbc/IoTDFSDataSource")}'/>
        </ns9:Severity>
        <xsl:variable name="query"
                      select="concat (&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;, &quot;'&quot;, /ns0:CustomerIncidentReq/ns0:Status, &quot;'&quot;, &quot; and isa='&quot;, $Invoke_getContactDetailsSelect_OutputVariable.DfsContactDetailsViewCollection/ns1:DfsContactDetailsViewCollection/ns1:DfsContactDetailsView/ns1:isa, &quot;'&quot; )"/>
        <ns9:StatusWithType>
          <ns9:Status>
