   ...
   <xsl:template match="/">
      <tns:Create>
         <tns:RNObjects xsi:type="ns9:Incident">
            ...
            <xsl:choose>
               <xsl:when test="string(/ns0:AlertData/ns0:payload/ns0:description)!='' and string(/ns0:AlertData/ns0:payload/ns0:probabilityValue)!='' and string(/ns0:AlertData/ns0:payload/ns0:timeToFail)!=''">
                  <ns9:Subject>
                     <xsl:value-of select="concat (/ns0:AlertData/ns0:payload/ns0:description, &quot;;&quot;, &quot;Probalility of Failure:&quot;, /ns0:AlertData/ns0:payload/ns0:probabilityValue, &quot;%;&quot;, &quot;Time to Fail:&quot;, /ns0:AlertData/ns0:payload/ns0:timeToFail,&quot;;&quot;, &quot;Trend:&quot;, /ns0:AlertData/ns0:payload/ns0:trendIndicator)"/>
                  </ns9:Subject>
               </xsl:when>
               <xsl:when test="string(/ns0:AlertData/ns0:payload/ns0:description)!=''">
                  <ns9:Subject>
