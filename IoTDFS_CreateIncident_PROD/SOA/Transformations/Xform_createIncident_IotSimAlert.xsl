...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns3="http://xmlns.oracle.com/pcbpel/adapter/db/IoT_DFS/IoTDFS_CreateIncident/get_Contact"
                xmlns:plnk="http://docs.oasis-open.org/wsbpel/2.0/plnktype"
                xmlns:jca="http://xmlns.oracle.com/pcbpel/wsdl/jca/"
                xmlns:ns2="http://xmlns.oracle.com/IoT_DFS/IoTDFS_CreateIncident/IotSimulatorAlert"
                xmlns:plt="http://schemas.xmlsoap.org/ws/2003/05/partner-link/"
                xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"
                xmlns:ns4="http://xmlns.oracle.com/IoT_DFS/IoTDFS_CreateIncident/Incident"
                xmlns:ns9="urn:objects.ws.rightnow.com/v1_3" xmlns:ns8="urn:generic.ws.rightnow.com/v1_3"
                xmlns:inp1="http://xmlns.oracle.com/IoT_DFS/IoTDFS_CreateIncident/CreateIncident"
                ...
                xmlns:ns11="http://xmlns.oracle.com/SOACS/IoTDFS_CreateIncident/IotSimulatorAlert">
      ...
      <tns:RNObjects xsi:type="ns9:Incident">
        ...
        <xsl:choose>
          <xsl:when test='string (/ns0:IoTSimAlert/ns0:payload/ns0:data/ns0:source_category ) != ""'>
            <xsl:variable name="query2"
                          select="concat(&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;,&quot;'&quot;,/ns0:IoTSimAlert/ns0:payload/ns0:data/ns0:source_category,&quot;'&quot;,&quot; and isa='&quot;,$Invoke_getContact_OutputVariable.get_ContactOutputCollection/ns1:get_ContactOutputCollection/ns1:get_ContactOutput/ns1:ISA,&quot;'&quot;)"/>
            <ns9:Category>
        ...
        <xsl:if test="string(/ns0:IoTSimAlert/ns0:payload/ns0:data/ns0:msg_priority)!=''">
          <xsl:variable name="query"
                        select="concat(&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;,&quot;'&quot;,/ns0:IoTSimAlert/ns0:payload/ns0:data/ns0:msg_priority,&quot;'&quot;,&quot; and isa='&quot;,$Invoke_getContact_OutputVariable.get_ContactOutputCollection/ns1:get_ContactOutputCollection/ns1:get_ContactOutput/ns1:ISA,&quot;'&quot;)"/>
          <ns9:Severity>
        ...
        <xsl:if test="string(/ns0:IoTSimAlert/ns0:payload/ns0:data/ns0:data_status)!=''">
          <xsl:variable name="query1"
                        select="concat(&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;,&quot;'&quot;,/ns0:IoTSimAlert/ns0:payload/ns0:data/ns0:data_status,&quot;'&quot;,&quot; and isa='&quot;,$Invoke_getContact_OutputVariable.get_ContactOutputCollection/ns1:get_ContactOutputCollection/ns1:get_ContactOutput/ns1:ISA,&quot;'&quot;)"/>
          <ns9:StatusWithType>
            <ns9:Status>
