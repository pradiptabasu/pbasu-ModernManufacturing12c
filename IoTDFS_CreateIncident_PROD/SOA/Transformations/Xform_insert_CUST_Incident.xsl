...
<xsl:stylesheet version="1.0" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:ns0="http://TargetNamespace.com/CustomerIncident_CreateCustomerIncident_request" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/top/insert_CRM_Incident" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:ns1="urn:messages.ws.rightnow.com/v1_3" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:ns4="http://xmlns.oracle.com/pcbpel/adapter/db/top/getContactDetails" exclude-result-prefixes="xsi oracle-xsl-mapper xsl xsd ns0 ns1 ns4 tns xp20 oraxsl mhdr oraext dvm xref socket" xmlns:ns3="http://xmlns.oracle.com/IoT_DFS/IoTDFS_CreateIncident/Incident" xmlns:ns9="urn:objects.ws.rightnow.com/v1_3" xmlns:ns2="http://xmlns.oracle.com/SOACS/IoTDFS_CreateIncident/CustomerIncident" xmlns:ns8="urn:generic.ws.rightnow.com/v1_3" xmlns:plt="http://schemas.xmlsoap.org/ws/2003/05/partner-link/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:inp2="http://xmlns.oracle.com/IoT_DFS/IoTDFS_CreateIncident/CreateIncident" xmlns:plnk="http://docs.oasis-open.org/wsbpel/2.0/plnktype" xmlns:jca="http://xmlns.oracle.com/pcbpel/wsdl/jca/" xmlns:ns6="urn:nullfields.ws.rightnow.com/v1_3" xmlns:ns7="urn:base.ws.rightnow.com/v1_3" xmlns:ns11="http://xmlns.oracle.com/pcbpel/adapter/db/SOACS/IoTDFS_CreateIncident/getContactDetails" xmlns:ns10="urn:metadata.ws.rightnow.com/v1_3" xmlns:ns5="urn:faults.ws.rightnow.com/v1_3" xmlns:ns12="http://xmlns.oracle.com/pcbpel/adapter/db/IoT_DFS/IoTDFS_CreateIncident/insert_CRM_Incident">
   ...
   <xsl:template match="/">
      <tns:CrmIncidentCollection>
         <tns:CrmIncident>
            ...
            <xsl:variable name="query" select="concat(&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;,&quot;'&quot;,/ns0:CustomerIncidentReq/ns0:Status,&quot;'&quot;,&quot; and isa='&quot;,$Invoke_getContactDetailsSelect_OutputVariable.DfsContactDetailsViewCollection/ns4:DfsContactDetailsViewCollection/ns4:DfsContactDetailsView/ns4:isa,&quot;'&quot;)"/>
            <tns:status>
            ...
            <xsl:variable name="query1" select="concat(&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;,&quot;'&quot;,/ns0:CustomerIncidentReq/ns0:Severity,&quot;'&quot;,&quot; and isa='&quot;,$Invoke_getContactDetailsSelect_OutputVariable.DfsContactDetailsViewCollection/ns4:DfsContactDetailsViewCollection/ns4:DfsContactDetailsView/ns4:isa,&quot;'&quot;)"/>
            <tns:incidentPriority>
               <xsl:value-of select="oraext:query-database($query1,false(),false(),&quot;jdbc/IoTDFSDataSource&quot;)"/>
            </tns:incidentPriority>
            <xsl:variable name="query2" select="concat(&quot;select lookup_code from DFS_RN_LOOKUPS where lookup_value=&quot;,&quot;'&quot;,/ns0:CustomerIncidentReq/ns0:Category,&quot;'&quot;,&quot; and isa='&quot;,$Invoke_getContactDetailsSelect_OutputVariable.DfsContactDetailsViewCollection/ns4:DfsContactDetailsViewCollection/ns4:DfsContactDetailsView/ns4:isa,&quot;'&quot;)"/>
            <tns:category>
